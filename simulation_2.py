...
if __name__ == '__main__':
    ...
    encap_tbl_D = {'H1' : (111, 1, 1, 11), 'H2' : (222, 1, 1, 11)}                                          # table used to encapsulate network packets into MPLS frames
    frwd_tbl_D = { (0, 111) : (2, 112), (1, 222) : (3, 223) }     # table used to forward MPLS frames
    decap_tbl_D = {335 : 0, 446 : 1}                                                                        # table used to decapsulate network packets from MPLS frames
    ...
    frwd_tbl_D = { (0, 112) : (1, 113) }     # table used to forward MPLS frames
    ...
    encap_tbl_D = {}                                                                                        # table used to encapsulate network packets into MPLS frames
    frwd_tbl_D = { (0, 223) : (1, 224) }     # table used to forward MPLS frames
    decap_tbl_D = {}                                                                                        # table used to decapsulate network packets from MPLS frames
    ...
    encap_tbl_D = {'H3' : (333, 1, 1, 11)}    
    frwd_tbl_D = {}     
    decap_tbl_D = {113 : 2, 224: 2}    
