...
if __name__ == '__main__':
    ...
    encap_tbl_D = {'H1' : (100, 1, 0, 10)}    # table used to encapsulate network packets into MPLS frames
    frwd_tbl_D = { (0, 100) : (1, 101), (1, 201) : (0, 202) }     # table used to forward MPLS frames
